...
***Cleaning***
import pandas as pd
data = pd.read_csv("E:\Latha\LathaSKPIMCS\Machine Learning\Class\Practical\Practical_1\RawData.csv")
print(data.columns)
...
# dictionary of lists  
dict = {'Index': Index, 'Company': Company, 'Location': Location, 'Salary':Salary, 'minimum_exp':minimum_exp, 'maximum_exp':maximum_exp}  
     
df = pd.DataFrame(dict) 
  
# saving the dataframe 
df.to_csv('E:\Latha\LathaSKPIMCS\Machine Learning\Class\Practical\Practical_1\File5.csv') 

#Read New dataset
data = pd.read_csv("E:\Latha\LathaSKPIMCS\Machine Learning\Class\Practical\Practical_1\File5.csv")
-->
...
df = pd.read_csv('C:\\Users\\Admin\\OneDrive\\Documents\\Machine Learning practicals\\shirtsize.csv')
print(df.columns)
df
